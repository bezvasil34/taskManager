...
$('form').on('submit', function(event){
  ...
  var newTask = '<label for="task--' + tasksN + '" class="task task--new"><input class="task__check" type="checkbox" id="task--' + tasksN + '" /> <div class="task__field task--row">' + taskText + '<input class="date" type="date"><a  class="edit" href="edit">edit</a><i class="fa fa-check" aria-hidden="true"></i></div></label>'
